...
# KEYWORDS
#   $Revision 1 $
#   $Source src/main/scripts/fr/geoportail/entrepot/scripts/publication/update_product_metadatas_folder.pl $
#   $Date: 22/03/12 $
...
my $logger =
  Logger->new( "update_product_metadatas_folder.pl", $logger_levels );

sub update_product_metadatas_folder {

    my $return_crawl_isoap;
    my $return_crawl_inspire;

    # validation zone ISOAP
