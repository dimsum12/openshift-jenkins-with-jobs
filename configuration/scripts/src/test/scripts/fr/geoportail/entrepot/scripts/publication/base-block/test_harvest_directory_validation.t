...
ok( harvest_directory_validation("url", "/my/folder", 1) == 0, "Test ok avec des métadonnées INSPIRE");
ok( harvest_directory_validation("url", "/my/folder", 0) == 0, "Test ok avec des métadonnées ISO");
...
ok( harvest_directory_validation("url", "/my/folder", 0) == 1, "crawl failed" );
...
ok( harvest_directory_validation("url", "/my/folder", 0) == 2, "test crawl failed" );
...
ok( harvest_directory_validation("url", "/my/folder", 1) == 3, "Test avec une erreur d'intégration des métadonnées");
...
ok( harvest_directory_validation("url", "/my/folder", 1) == 4, "Test timeout");



# test
ok( harvest_directory_validation() == 255, "testWithoutParameters" );