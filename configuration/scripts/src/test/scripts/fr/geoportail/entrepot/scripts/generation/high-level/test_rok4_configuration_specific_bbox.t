...
require "rok4_configuration_specific_bbox.pl";
...
ok( rok4_configuration_specific_bbox() == 255, "testWithoutParameters" );
...
ok( rok4_configuration_specific_bbox("-1", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 1, "testWithBadGenerationId" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 0
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 15
		&& `more $tmp_path/$tmp_generation/15/$config_file_name | wc -l` eq `more $resources_path/be4/be4_specific_update.conf | wc -l`
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "true", "4", "8") == 0
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "false", "4", "8") == 0
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 1, "testWithUnreachableService" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "false") == 2, "testWithMultipleDeliveriesInput" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 2, "testWithBadDeliveryInput" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 3, "testWithMultipleBroadcastDatasOutput" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "false") == 253, "testWithNoStorageBroadcastDataOutput" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 252, "testWithBadAncestorBroadcastData" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "false", "4", "8") == 2, "testWithNoHarvestingLayer" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "true", "4", "8") == 8, "testWithHarvestingLayerNotPublished" );
...
`mkdir -p $root_storage/fake_storage/20/$pyramid_dir/`;
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 7
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 13
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "true") == 4, "testWithoutInformationFile" );
...
ok( rok4_configuration_specific_bbox("16", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "true") == 5, "testWithErrorCreatingBe4Conf" );
...
ok( rok4_configuration_specific_bbox("16", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "true") == 6, "testWithErrorCreatingPyramidDir" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 9, "testWithErrorUpdatingBroadcastData" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 9, "testWithErrorUpdatingBBoxes" );
		

`mv $resources_path/complete_delivery_raster_ok/Livraison1/bbox_wkt.txt $resources_path/complete_delivery_raster_ok/Livraison1/bbox_wkt.txt.tmp`;		
$mocked_call = "0";
$mock = Test::MockObject->new();
$mock->fake_module(
        'HTTP::Response',
...
);
{
    ...
    ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 10, "testWithErrorCalculatingBBox" );
}

`mv $resources_path/complete_delivery_raster_ok/Livraison1/bbox_wkt.txt.tmp $resources_path/complete_delivery_raster_ok/Livraison1/bbox_wkt.txt`;
...

{
	...
	ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "true", "true") == 11
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "no_exist", "true", "true") == 12, "testWithIncorrectPreprocessing" );
...
ok( rok4_configuration_specific_bbox("15", "LAMB93_10cm", "raw", "", "4096", "4096", "8", "uint", "rgb", "3", "bicubique", "1", "FF", "none", "false", "true") == 254, "testWithJsonConversionError" );
