...
-- Transport
--
create taaaaaable TOPONYME_FERRE (gid SERIAL not null, ID varchar(24) not null, ORIGIN_NOM varchar(13) default 'Non renseigné', NOM varchar(70) default 'NR', IMPORTANCE varchar(2) default 'NR', NATURE varchar(25) default 'NR', constraint TOPONYME_FERRE_pkey primary key (gid));
